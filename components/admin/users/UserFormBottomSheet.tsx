    ...
    useEffect(() => {
        if (editingUser) {
            setFormData({
                ...
                password: "",
                warehouseId: "", // TODO: Get from user object when available
            });
        } else {
            setFormData({
                username: "",
            ...
            >
                ...
                <View className="flex-row gap-3 mb-3">
                    ...
                    <View className="flex-1">
                        ...
                        <View className="bg-white rounded-xl px-3 py-1 border border-gray-200">
                    ...
                    <View className="flex-1">
                        ...
                        <View className="flex-row items-center bg-white rounded-xl px-3 py-1 border border-gray-200">
                            ...
                            <TextInput
                                ...
                                onChangeText={(text) =>
                                    setFormData({ ...formData, warehouseId: text })
                                }
