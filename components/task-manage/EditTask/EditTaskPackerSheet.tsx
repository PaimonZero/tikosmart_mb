...
interface EditTaskPackerSheetProps {
  onSelect: (user: PickerUser) => void;
}

const EditTaskPackerSheet = forwardRef<BottomSheetModal, EditTaskPackerSheetProps>(
  ({ onSelect }, ref) => {
    const snapPoints = useMemo(() => ["60%", "80%"], []);
    const { pickers, loading, loadInitial, loadMore, search } = usePickerList();
...
export default EditTaskPackerSheet;
