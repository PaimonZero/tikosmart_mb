import PackerPickerSheet from '@/components/task-manage/AddTask/PackerPickerSheet';
...
interface TaskBasicInfoCardProps {
    orderNo?: string;
    customerName?: string;
...
const TaskBasicInfoCard = ({
    ...
    return (
        <>
            ...
            <PackerPickerSheet
                ref={packerSheetRef}
                onSelect={onPackerSelect}
            />
        </>
    );
};

export default TaskBasicInfoCard;
