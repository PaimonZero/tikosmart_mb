...
function getRoleDashboardRoute(role: string): string {
    ...
    return roleRoutes[role] || "/(seller)/dashboard";
}
...
export default function LoginScreen() {
    ...
    useEffect(() => {
        ...
        const run = async () => {
            ...
            try {
                ...
                toast.error("Lỗi", {
                    description: "Dữ liệu server trả về không hợp lệ",
                    duration: 5000,
                });
                router.replace("/login");
            }
    ...
    const onSubmit = async () => {
        ...
        try {
            ...
            toast.success(
                remember ? "Đã ghi nhớ đăng nhập." : "Đăng nhập thành công.",
                { duration: 3000 },
            );
            router.replace(dashboardRoute as any);
        } catch (e: any) {
                    ...
                    >
                        ...
                        <Card style={styles.card} mode="elevated">
                            <Card.Content style={styles.cardContent}>
                                ...
                                <LoginButton onPress={onSubmit} isLoading={isLoading} />
